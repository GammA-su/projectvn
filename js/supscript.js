var canvas;
var background0, background0gif, background_menu, background_text, background_1, background_2, background_3;
...
function preload(){
    ...
    myFont = loadFont("fonts/rosewoodstd.otf");
}
...
function draw(){
    ...
    function gen(num,cha){
            if (active == "intro" || active == "waiting+anim"){
                var intro = ["Il existe en ce monde...", "...une chose que personne n'a jamais vue.", "FRANGE DE CÔTÉ ELLE AIMERA", "C'est un mensonge.","Ça ne sert à rien... Bon sang...", "Du moisi ? C'est une blague ou quoi "]
                var character = ['Ryuuji', 'Ryuuji', '---','Ryuuji','Ryuuji','Ryuuji']
                var background = [background_1,background_1,background_2,background_2,background_2,background_3,background_3,background_3,background_2,background_2,background_3] 
    ...
    function _intro_(){
        if (state == 0){
                if (current_num == 2 && anim == false || current_num == 5 && anim == false ){
                active = "waiting+anim";
                ...
                if (current_num == 3 || current_num == 6 ){
                    anim = false;
                }
                clear();
                reset();
